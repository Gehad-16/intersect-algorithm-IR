...
public class InvertedIndex003 {
 ...
 /**/ 
        ...
        String phrase_1 = "independently AND category";
        String phrase_2="Software OR Engineering";
        String phrase_3="Software AND NOT Engineering";
        String phrase_4="Software OR NOT Engineering";
        System.out.println(index.find_01(phrase_1));
  /**/        
